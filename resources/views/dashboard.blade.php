...
<div class="flex justify-center">
    <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col md:flex-row items-center">
      <div class="w-8/12 lg:w-6/12 px-5">
        ...
        <img src="{{ $user->image ? asset('profile'. '/' . $user->image) : asset('img/usuario.svg') }}" alt="img user">
      </div>
         ...
         <div class="flex items-center gap-2">
            ...
            @auth
              @if ($user->id === auth()->user()->id)
                ...
                <a href="{{ route('profile.index' ) }}" class="text-gray-500 hover:text-gray-700 cursor-pointer" href="">
...
<section class="container mx-auto mt-10">
   ...
   @else
      <p class="text-gray-600 uppercase text-sm text-center font-bold ">There is no Posts</p>
  @endif
</section>
@endsection